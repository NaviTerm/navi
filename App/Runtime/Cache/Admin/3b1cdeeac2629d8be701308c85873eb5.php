...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li onclick="location='<?php echo U('admin/banner/add');?>'">
            <span><img src="<?php echo (AD_SKIN); ?>images/t01.png" /></span>添加幻灯片
        </li>
        <li class="form_seva">
...
<form method="post" id="form_seva" action="<?php echo U('banner/update_seva');?>">
...
<?php if(is_array($lists)): foreach($lists as $key=>$t): ?><tr>
    ...
    <td class="imgtd"><img src="<?php echo ($t[thumb]); ?>" /></td>
    <td><a href="#"><?php echo ($t[title]); ?></a><p>发布时间：<?php echo (date('Y-m-d H:i:s',$t[addtime])); ?></p></td>
    <td><?php echo (msubstr(strip_tags($t[introduce]),0,30)); ?></td>
    <td>
        <a href="<?php echo U('admin/banner/update',array('itemid'=>$t[itemid]));?>">编辑</a>&nbsp;&nbsp;
        <a href="<?php echo U('admin/banner/delete',array('itemid'=>$t[itemid]));?>">删除</a>
    </td>
