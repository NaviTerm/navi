    ...
    <div class="wrapper">
        ...
        <nav>
            <ul>
                ...
                <li class="client"><a href="<?php echo U('./case');?>"  title="解决方案">解决方案<span>我们有什么？</span></a></li>
            </ul>
        </nav>
    </div>
</header>
...
<footer>
	...
	<div id="footerinfo">
		<div class="wrapper">
			...
			<p>
				<a target="_blank" href="javascript:if(confirm('http://wpa.qq.com/msgrd?v=3&uin=429592913&site=qq&menu=yes))window.location='http://wpa.qq.com/msgrd?v=3&uin=89091392&site=qq&menu=yes'" tppabs="http://wpa.qq.com/msgrd?v=3&uin=429592913&site=qq&menu=yes"><img border="0" src="images/qq.png"  alt="点击这里给我发消息" title="点击这里给我发消息"/></a><br/>
				电话：400 8888 8888<br/>
				传真：400 8888 8888<br/>                                       
				电子邮件：admin@u.com<br/>
				公司地址：某某某某某某某某某<br/>
				备案编号：蜀ICP备000000001<br/>
				Copyright © 2006 - 2012 luidea.com All rights reserved. 
			</p>
			<img src="images/map.png"  id="homemap" width="258" height="190" alt="公司位置" />
		</div>
		<div class="Copyright">
